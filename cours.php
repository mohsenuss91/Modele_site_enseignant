...
<head>
    ...
    <title> Professeur Zayd Amr-Cours-الأستاذ زيد عمر </title>
</head>
...
<div id="wrapper">
    ...
    $sql = 'SELECT `id`, `nom`, `mime`, `taille`, `created` FROM `cours`';
            ...
            while($row = $result->fetch_assoc()) {
                echo "
                    <tr>
                        ...
                        <td>{$row['taille']}</td>
                        <td>{$row['created']}</td>
                        <td><a href='get_file.php?id={$row['id']}'>Télécharger</a></td>
                    </tr>";
            }
